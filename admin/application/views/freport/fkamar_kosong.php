...
<?	if ($display=="0"){
		echo '<a href="'.base_url("rpt_kamar/kamar_kosong/kosong_1").'" title="Generate to pdf"><img src="'.base_url("assets/images/oficina_pdf.png").'" width=40 ><B><font size="2" style="Courier New" >Cetak ke Pdf</font></B></a>&nbsp;<BR>';
	}
...
<div class="row" style="text-align:center">
	<div class="col-md-12">	<input type="hidden" name="param" id="param" value="<?=$param?>">
		...
		<a href="<?=base_url("rpt_kamar/kamar_kosong/kosong_1")?>" class="btn btn-success">Cetak/Download</a><br>		
	</div>
</div>	
<?}?>
<script>
