		...
		<div class="form-group"><label class="col-sm-4 control-label">Lokasi/Cabang Kost</label>
			...
			<?	
				if ($this->session->userdata('auth')->ROLE=="Superadmin"){
					echo form_dropdown('lokasi_bln',$lokasi,'','id="lokasi_bln" class="form-control"');
				}else{
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Tarif</label>
			<div class="col-sm-3"><?=form_input(array("name"=>"bln_tarif","id"=>"bln_tarif","class"=>"form-control", "readonly"=>true));?></div>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Fasilitas</label>
			<div class="col-sm-8"><?=form_textarea(array("name"=>"bln_fasilitas","id"=>"bln_fasilitas","class"=>"form-control", "readonly"=>true, "rows"=>3, "cols"=>30));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Daftar</label>
			...
			<div class="input-group input-group-sm">
				<input type="text" id="bln_tgldaftar" name="bln_tgldaftar" class="form-control" value="<?php echo date('Y-m-d')?>"/>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Mulai Inap</label>
			...
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tglinap" name="bln_tglinap" class="form-control" value="<?php echo date('Y-m-d')?>" />
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tgllahir1" name="bln_tgllahir1" class="form-control" />
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tgllahir2" name="bln_tgllahir2" class="form-control" />
					...
					bootbox.dialog({
					  ...
					  buttons: {
						...
						primary: {
						  ...
						  callback: function() {
							//printReg(msg.noreg, "bulanan");							
							window.location.href="https://wa.me/"+nohp+"?text=Login aplikasi penghuni : username: "+$("#bln_email1").val()+", password: 12345";
							}
							},
						main: {
						  label: "Tutup",
