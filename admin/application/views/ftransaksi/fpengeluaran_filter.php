<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="col-sm-4"><?=form_dropdown('jenis',array("Rutin"=>"Rutin", "Insidentil"=>"Insidentil"),'','id="jenis" class="form-control"');?></div>
		</div><!-- form-group -->
	</div>
        ...
        $('#mydatatables').dataTable({
			...
			"fnServerParams": function ( aoData ) {
				aoData.push(
					...
					{ "name": "tanggal", "value": $('#tanggal').val()},
					{ "name": "lokasi", "value": $('#cb_lokasi').val() }
				);
			},
			"aoColumns": [
				{"mData": "NO" },
			...
			"sAjaxSource": "<?php echo base_url('e_pengeluaran/json_data');?>"
		});
