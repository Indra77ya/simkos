...
<?php echo form_open(null,array("class"=>"form-horizontal","id"=>"myform_bln_edit"));?>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No. Registrasi</label>
			<div class="col-sm-4"><input type="hidden" name="bln_noreg" id ="bln_noreg" size="20" value="<?php echo $res->idpendaftaran?>"/><label class="col-sm-4 control-label"><B><?php echo $res->idpendaftaran?></B></label></div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Tarif</label>
			<div class="col-sm-3"><?=form_input(array("name"=>"bln_tarif","id"=>"bln_tarif","class"=>"form-control", "readonly"=>true, "value"=>$res->tarifbulanan));?></div>
			<label  class="col-sm-2 control-label">&nbsp;Diskon Tarif</label><div class="col-sm-3"><?=form_input(array("name"=>"bln_diskon","id"=>"bln_diskon","class"=>"form-control","onkeypress"=>"return numericVal(this,event)", "onblur"=>"blurObj(this)", "onclick"=>"clickObj(this)",  "value"=>$res->diskon));?></div>
		</div>
	</div>
</div> 
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Fasilitas</label>
			<div class="col-sm-8"><?=form_textarea(array("name"=>"bln_fasilitas","id"=>"bln_fasilitas","class"=>"form-control", "readonly"=>true, "rows"=>3, "cols"=>30, "value"=>$res->fasilitas));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Daftar</label>
			...
			<div class="input-group input-group-sm ">
				<input type="text" id="bln_tgldaftar" name="bln_tgldaftar" class="form-control" value="<?php echo $res->tgldaftar?>"/>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Mulai Inap</label>
			...
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tglinap" name="bln_tglinap" class="form-control" value="<?php echo $res->tglmulai?>" />
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Posisi Meteran Listrik</label>
			<div class="col-sm-4"><?=form_input(array("name"=>"bln_posisi_meteran","id"=>"bln_posisi_meteran","class"=>"form-control","onkeypress"=>"return numericVal(this,event)", "onblur"=>"blurObj(this)", "onclick"=>"clickObj(this)", "value"=>$res->kwh_awal));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Deposit</label>
			<div class="col-sm-4"><?=form_input(array("name"=>"bln_deposit","id"=>"bln_deposit","class"=>"form-control","onkeypress"=>"return numericVal(this,event)", "onblur"=>"blurObj(this)", "onclick"=>"clickObj(this)", "value"=>$res->deposit));?>	</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Nama Lengkap*</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_nama_lengkap1","id"=>"bln_nama_lengkap1","class"=>"form-control", "value"=>$res->NAMA));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Foto</label>
			<div class="col-sm-8"><?=form_upload(array('name'=>'userfile','id'=>'userfile','class'=>'form-control', 'onchange'=>"readURL(this,'imgFoto_bln')"));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgFoto_bln" name="imgFoto_bln" src="<?php echo base_url("assets/images/".($res->FOTO==""?"placeholder/none.gif":"foto/".$res->FOTO))?>" width="130" height="150">	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No. Identitas	(KTP/SIM/NIM)*</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_identitas1","id"=>"bln_identitas1","class"=>"form-control", "value"=>$res->NOIDENTITAS));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Upload Kartu Identitas</label>
			<div class="col-sm-8"><?=form_upload(array('name'=>'filecard','id'=>'filecard','class'=>'form-control', 'onchange'=>"readURL(this,'imgCard_bln')"));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgCard_bln" name="imgCard_bln" src="<?php echo base_url("assets/images/".($res->IMGIDENTITAS==""?"placeholder/none.gif":"foto/".$res->IMGIDENTITAS))?>" width="250" height="150">	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No.Telp/HP*</label>
			<div class="col-sm-6"><?=form_input(array("name"=>"bln_notelp1","id"=>"bln_notelp1","class"=>"form-control","onkeypress"=>"return numericVal(this,event)", "value"=>$res->NOTELP));?>	</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Jenis Kelamin</label>
			<div class="col-sm-4"><?php	echo form_dropdown('bln_jnskelamin1',array('Pria'=>'Pria', 'Wanita'=>'Wanita'),$res->JENISKELAMIN,'id="bln_jnskelamin1" class="form-control"' );?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tempat Lahir</label>
			<div class="col-sm-6"><?=form_input(array("name"=>"bln_tempatlahir1","id"=>"bln_tempatlahir1","class"=>"form-control", "value"=>$res->TEMPAT_LAHIR));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tgllahir1" name="bln_tgllahir1" class="form-control" VALUE="<?php echo $res->TGLLAHIR?>"/>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Alamat Asal </label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_alamat1","id"=>"bln_alamat1","class"=>"form-control", "value"=>$res->ALAMAT_ASAL));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Nama Instansi(Sekolah/Kampus/Kantor)</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_nama_instansi","id"=>"bln_nama_instansi","class"=>"form-control" ,"value"=>$res->NAMA_PT));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Alamat Instansi(Sekolah/Kampus/Kantor) </label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_alamat_instansi","id"=>"bln_alamat_instansi","class"=>"form-control","value"=>$res->ALAMAT_KERJA_KULIAH));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No.Telp Instansi</label>
			<div class="col-sm-4"><?=form_input(array("name"=>"bln_notelp_instansi","id"=>"bln_notelp_instansi","class"=>"form-control","onkeypress"=>"return numericVal(this,event)","value"=>$res->NOTELP_INSTANSI));?>	</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Nama Lengkap</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_nama_lengkap2","id"=>"bln_nama_lengkap2","class"=>"form-control","value"=>$res->NAMA_PJ));?>	</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No. Identitas	(KTP/SIM/NIM)</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_identitas2","id"=>"bln_identitas2","class"=>"form-control","value"=>$res->NOIDENTITAS_PJ));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">No.Telp/HP</label>
			<div class="col-sm-6"><?=form_input(array("name"=>"bln_notelp2","id"=>"bln_notelp2","class"=>"form-control","onkeypress"=>"return numericVal(this,event)","value"=>$res->NOTELP_PJ));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">E-mail</label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_email2","id"=>"bln_email2","class"=>"form-control","value"=>$res->EMAIL_PJ));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Jenis Kelamin</label>
			<div class="col-sm-4"><?php	echo form_dropdown('bln_jnskelamin2',array('Pria'=>'Pria', 'Wanita'=>'Wanita'),$res->JENISKELAMIN_PJ,'id="bln_jnskelamin2" class="form-control"');?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tempat Lahir</label>
			<div class="col-sm-6"><?=form_input(array("name"=>"bln_tempat_lahir2","id"=>"bln_tempat_lahir2","class"=>"form-control","value"=>$res->TEMPAT_LAHIR_PJ));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="bln_tgllahir2" name="bln_tgllahir2" class="form-control" value="<?php echo $res->TGL_LAHIR_PJ?>"/>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Alamat </label>
			<div class="col-sm-8"><?=form_input(array("name"=>"bln_alamat2","id"=>"bln_alamat2","class"=>"form-control","value"=>$res->ALAMAT_PJ));?>	</div>
		</div>
	</div>
</div>
...
<?	$strCek=" select count(*) cek from detildaftar where idpendaftaran ='".$res->idpendaftaran."' and idanakkost='".$res->IDANAKKOST."' and idBiaya<>0";
...
<?
		...
		$sqlBiaya=" select d.*, b.tarif from detildaftar d, biaya_tambahan b where d.idBiaya=b.id and idpendaftaran ='".$res->idpendaftaran."' and idanakkost='".$res->IDANAKKOST."'";
