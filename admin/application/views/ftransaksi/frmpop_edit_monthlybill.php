...
<tr ><td colspan=2>&nbsp;</td>
	<td colspan=4>
<?  if ($jenis=="Tahunan") {?>
	<INPUT TYPE="hidden" name="thnbln" id="thnbln" value="<?=$res->periode_tagihan?>">
	<?} ?>
	<INPUT TYPE="hidden" name="jenis" id="jenis" value="<?=$jenis?>">
	<INPUT TYPE="hidden" name="periode" id="periode" value="<?=$periode?>">
	<INPUT TYPE="hidden" name="no_kuit" id="periode" value="<?=$no_kuit?>">
...
$('#btsimpan').click(function(){		
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url('e_pembayaran/saveEditing_thnn');?>',
			data: form_data,				
			dataType: 'json',
