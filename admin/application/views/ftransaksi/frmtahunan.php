...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Kamar*</label>
			<div class="col-md-8 form-inline"><?=form_input(array("name"=>"thn_lblkamar","id"=>"thn_lblkamar","class"=>"form-control"));?>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgFoto_thn" name="imgFoto_thn" width="130" height="130">	</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgCard_thn" name="imgCard_thn" width="250" height="150">	</div>
		</div>
	</div>
</div>
<div class="row">
