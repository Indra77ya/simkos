		...
		<div class="form-group"><label class="col-sm-4 control-label">Lokasi/Cabang Kost</label>
			...
			<?	
				if ($this->session->userdata('auth')->ROLE=="Superadmin"){
					echo form_dropdown('lokasi_mgg',$lokasi,'','id="lokasi_mgg" class="form-control"');
				}else{
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Kamar*</label>
			<div class="col-sm-4 form-inline"><?=form_input(array("name"=>"mgg_lblkamar","id"=>"mgg_lblkamar","class"=>"input-small"));?>
			<input type="hidden" name="mgg_idkamar" id="mgg_idkamar" size="20" readonly />
			&nbsp;
			<? echo '<a href="javascript:void(0)" id="btn_mgg_pilihkamar" class="btn btn-purple btn-sm inline" >Pilih Kamar</a>'; ?>
				</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Tarif</label>
			<div class="col-sm-3"><?=form_input(array("name"=>"mgg_tarif","id"=>"mgg_tarif","class"=>"form-control", "readonly"=>true));?></div>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label  class="col-sm-4 control-label">Fasilitas</label>
			<div class="col-sm-8"><?=form_textarea(array("name"=>"mgg_fasilitas","id"=>"mgg_fasilitas","class"=>"form-control", "readonly"=>true, "rows"=>3, "cols"=>30));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Check In*</label>
			...
			<div class="input-group input-group-sm">
				<input type="text" id="mgg_tglcheckin" name="mgg_tglcheckin" class="form-control" />
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Check Out</label>
			...
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="mgg_tglcheckout" name="mgg_tglcheckout" class="form-control" readonly/>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="mgg_tgllahir1" name="mgg_tgllahir1" class="form-control" />
...
<div class="row">
	...
	<!-- <button class="btn  btn-primary" id="btsimpan_mgg"><i class="ace-icon fa fa-floppy-o bigger-125"></i>Simpan</button> -->
	<button class="btn  btn-warning" id="btcancel_mgg"><i class="ace-icon fa fa-refresh bigger-125"></i>Batal</button>
