<div class="alert alert-info">
	...
	<ul>
	<li>Sewa Mingguan dapat memproses pembayaran dimuka (DP), dan selanjutnya dapat melakukan pelunasan pada halaman yang sama yaitu pada menu entri pembayaran sewa Harian atau pada halaman edit pembayaran ini</li>		
...
<?php echo $resDaftar->lama." Hari x ( Rp. ".number_format($resDaftar->tarifmingguan,2,',','.')." - Diskon Rp. ".number_format($resDaftar->diskon,2,',','.')." )  = <b>Rp. ".number_format(($resDaftar->lama* ( $resDaftar->tarifmingguan - $resDaftar->diskon)),2,',','.')."</b>"; ?>
...
function editThis(jenis, noreg, nourut, tglbayar, idlokasi){
		...
		$.ajax({
			...
			dataType: 'html',
			type: 'POST',
			data: {ajax:'true', noreg:noreg, jenis:jenis, nourut:nourut, idlokasi:idlokasi },
			success:
