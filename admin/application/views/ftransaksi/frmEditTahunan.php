...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgFoto_thn" name="imgFoto_thn" src="<?php echo base_url("assets/images/".($res->FOTO==""?"placeholder/none.gif":"foto/".$res->FOTO))?>">	</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group"><label class="col-sm-4 control-label">&nbsp;</label>
			<div class="col-sm-8"><img id="imgCard_thn" name="imgCard_thn" src="<?php echo base_url("assets/images/".($res->IMGIDENTITAS==""?"placeholder/none.gif":"foto/".$res->IMGIDENTITAS))?>">	</div>
		</div>
	</div>
</div>
<div class="row">
