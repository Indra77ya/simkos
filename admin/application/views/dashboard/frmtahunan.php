...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Kamar</label>
			<div class="col-md-7 "><?=form_input(array("name"=>"thn_lblkamar", "value"=>$kamar->LABELKAMAR,"id"=>"thn_lblkamar", "readonly"=>true,"class"=>"form-control"));?>
			<input type="hidden" name="thn_idkamar" id="thn_idkamar" value="<?php echo $kamar->IDKAMAR?>"   />			
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Tarif</label>
			<div class="col-sm-3"><?=form_input(array("name"=>"thn_tarif", "value"=>$kamar->TARIFTAHUNAN,"id"=>"thn_tarif","class"=>"form-control", "readonly"=>true));?></div>
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Fasilitas</label>
			<div class="col-sm-8"><?=form_textarea(array("name"=>"thn_fasilitas", "value"=>$kamar->FASILITAS,"id"=>"thn_fasilitas","class"=>"form-control", "readonly"=>true, "rows"=>3, "cols"=>30));?>	</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-6">
				<div class="input-group input-group-sm">
					<input type="text" id="thn_tgllahir1" name="thn_tgllahir1" class="form-control" style="position: relative; z-index: 1600;" readonly/>
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-6">
				<div class="input-group input-group-sm">
					<input type="text" id="thn_tgllahir2" name="thn_tgllahir2" class="form-control" style="position: relative; z-index: 1600;" readonly/>
...
<table  border="0" cellspacing=0 id="tbDetil_thn" class="table  table-bordered table-hover">   
  ...
  <tr valign=top>
			<td>1</td>
			<td><select name="cbJnsBiayaThn_0" id="cbJnsBiayaThn_0" onchange="displayTarifThn(this,0)" class="form-control"> 
...
<tr>
    <td align="center">
	<INPUT TYPE="button" name="btAddRowThn" id="btAddRowThn" value="Tambah Biaya" class="btn btn-purple " onClick="addRowThn('tbDetil_thn',)" >
