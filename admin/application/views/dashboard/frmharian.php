...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Kamar</label>
			<div class="col-sm-7 "><?=form_input(array("name"=>"hr_lblkamar", "value"=>$kamar->LABELKAMAR, "readonly"=>true,"id"=>"hr_lblkamar","class"=>"form-control"));?>
			<input type="hidden" name="hr_idkamar" id="hr_idkamar" size="20" value="<?php echo $kamar->IDKAMAR?>" readonly /></div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Tarif</label>
			<div class="col-sm-3"><?=form_input(array("name"=>"hr_tarif","id"=>"hr_tarif", "value"=>$kamar->TARIFHARIAN,"class"=>"form-control", "readonly"=>true));?></div>
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label  class="col-sm-4 control-label">Fasilitas</label>
			<div class="col-sm-8"><?=form_textarea(array("name"=>"hr_fasilitas", "value"=>$kamar->FASILITAS,"id"=>"hr_fasilitas","class"=>"form-control", "readonly"=>true, "rows"=>3, "cols"=>30));?>	</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Check In</label>
			...
			<div class="input-group input-group-sm">
				<input type="text" id="hr_tglcheckin" name="hr_tglcheckin" class="form-control" style="position: relative; z-index: 1600;" readonly />
				<span class="input-group-addon" id="hr_tglcheckin_ico">
				<i class="ace-icon fa fa-calendar"></i>
				</span><label class="control-label">*yyyy-mm-dd</label>
				</div>
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Check Out</label>
			...
			<div class="col-sm-4">
				<div class="input-group input-group-sm">
					<input type="text" id="hr_tglcheckout" name="hr_tglcheckout" class="form-control" style="position: relative; z-index: 1600;" readonly/>
...
<div class="row">
	<div class="col-md-11">
		<div class="form-group"><label class="col-sm-4 control-label">Tanggal Lahir</label>
			<div class="col-sm-6">
				<div class="input-group input-group-sm">
					<input type="text" id="hr_tgllahir1" name="hr_tgllahir1" class="form-control" style="position: relative; z-index: 1600;" readonly/>
