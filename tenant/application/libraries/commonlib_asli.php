...
class commonlib {
	...
	$sHtml.="<style>";
	$sHtml.=" body { ";
	$sHtml.=" background:  url(".base_url('assets/images/kuitansi.png').") no-repeat fixed;";
	$sHtml.=" border:1px solid #000;font-family: Arial; font-size: 12px; "; 
	$sHtml.=" width:950px; height: 300px; 	 }";
	$sHtml.=".kwitNo{";
	$sHtml.="	margin:20px 20px 5px 20px;";
	$sHtml.="	text-align:left;";
	$sHtml.="	font-size: 14px; font-weight:Bold;color:#2626BF	}";
	$sHtml.=".mytb{";
	$sHtml.="	background:  url(".base_url('assets/images/kuitansi.png').") no-repeat fixed;";
	$sHtml.="}";
	$sHtml.=".leftBar{";
	...
	//$sHtml.="float:left;";
	$sHtml.="}";
	$sHtml.=".mydata {border: 1px solid #dcdcdc; margin: 10px 0px 0px 0px;  border-collapse: collapse;font-size: 11px;}";
	$sHtml.=".mydata th{padding: 8px 4px 8px 4px;border: 1px solid #dcdcdc; background: #88bc1a; }";
	$sHtml.=".mydata td{padding: 4px; border: 1px solid #dcdcdc;color: #5b5b5b;vertical-align: top;}";
